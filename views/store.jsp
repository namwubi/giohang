					...
					<div class="row">
						...
						<c:forEach var="product" items="${products}">
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="views/img/product/${product.image}" >
										
										<div class="product-label">
											<span class="sale">-10%</span> <span class="new">NEW</span>
										</div>
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										...
										<h4 class="product-price"><fmt:formatNumber value="${product.price}"/> 
											<del class="product-old-price"><strike><fmt:formatNumber value="${product.price *(1.1)}"/></strike></del>
										</h4>
